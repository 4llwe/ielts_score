...
const files=['index.html','assets/styles.css','assets/app.js','netlify.toml','netlify/functions/api.mjs','data/seed.json','assets/audio/listening-demo.mp3','manifest.webmanifest','sw.js','assets/icons/icon-192.png','assets/icons/icon-512.png','README.md'];
