...
const files = [
  ...
  "private-materials/toefl-preparation-2026-form-a/README.txt",
  "ops/README.md",
  "scripts/readiness-evidence-check.mjs",
  "netlify.toml",
...
for (const s of ['id="main"', 'aria-label="Navigasi utama"', "viewport"])
  if (!html.includes(s)) {
    console.error("HTML check failed:", s);
    ok = false;
  }
